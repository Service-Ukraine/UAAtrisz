const getBackendServerUrl = () => {
  ...
  let projectSubDomain = parseCookieForDomain();
  return `https://${projectSubDomain}.api.drapcode.io/api/v1/`;
};
...
const parseCookieForDomain = () => {
  ...
  return parsedCookie['projectSeoName'];
};

const IMAGE_SERVER_URL = 'https://drapcode-upload.s3.amazonaws.com/';
